...
public class TCPClient {
    ...
    /*
        ...
        实现步骤：
            ...
            4. 使用Socket对象中的方法getInputStream()获取网络自己输入流InputStream对象
            5. 使用网络字节输入流InputStream对象中的方法read，读取服务器回写的数据；
            6. 释放资源（Socket）
         注意：
            1. 客户端和服务器端进行交互的时候，必须使用Socket中提供的网络流，不能使用自己创建的流对象。
            2. 当我们创建客户端对象Socket的时候，就会去请求服务器和服务器经过3次握手建立连接通路
                这时，如果服务器没有启动，那么就会抛出ConnectException异常
